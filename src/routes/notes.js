...
router.get('/notes', isAuthenticated, async (req,res)=>{
    const hoy = new Date("1021-10-23T00:00:00.000+00:00")
    const notes = await Note.find({user: req.user.id, dia: {$gt: new Date(hoy.getTime() + 1000 * 86300 * 1)}}).lean().sort({date:'desc'});
